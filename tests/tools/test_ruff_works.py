...
def test_ruff_works(
    ...
    expected_out = (
        ...
        f"{expected_path_0}:cell_4:3:1: E402 Module level import not at top of file\n"
        f"{expected_path_0}:cell_4:3:20: F401 [*] `random.randint` imported but unused\n"
        f"{expected_path_0}:cell_5:3:1: E402 Module level import not at top of file\n"
        f"{expected_path_0}:cell_5:4:1: E402 Module level import not at top of file\n"
